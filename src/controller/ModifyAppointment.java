...
/**
 * This class is the controller for modify-appointment.fxml view.
 * User selects a row from the Appointment tableview from the Main Menu and info populates to this screen.
 * User can change any modifiable fields.
 */
public class ModifyAppointment {

    /**
     * Modified fields will be saved to the Appointment tableview on the Main Menu.
